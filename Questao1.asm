...
main:
    ...
    pedeRaio:
        ...
        areaR     ;Chama a nossa macro que cálcula a área com o raio já informado pelo usuário
    ...
    pedeDiametro:
        ...
        areaD    ;Chama a nossa macro que cálcula a área com o diâmetro informado pelo usuário
